...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String tipousuario = getIntent().getStringExtra("NIVEL").toString();

        switch (tipousuario)
        {
            case "ADMINISTRADOR":{

                tabLayout.addTab(tabLayout.newTab().setText("BIENVENID@"));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            String nivel = getIntent().getStringExtra("NIVEL").toString();
            ...
            switch (nivel)
            {
                ...
                case "GERENTE":{
                    ...
                    {
                        case 0:{
                            BienvenidaFragment2 bienvenidaFragment2 = new BienvenidaFragment2();
                            return bienvenidaFragment2;
                        }
                        case 1:{
                            ConsultaFragment consultaFragment = new ConsultaFragment();
                            return consultaFragment;
                ...
                case "PERSONAL":{
                    ...
                    {
                        case 0:{
                            BienvenidaFragment3 bienvenidaFragment3 = new BienvenidaFragment3();
                            return bienvenidaFragment3;
                        }
        ...
        public int getCount() {
            ...
            switch (nivel)
            {
                case "ADMINISTRADOR":{ cantidad = 3; break;}
                case "GERENTE":{ cantidad = 2; break;}
                case "PERSONAL":{ cantidad = 1; break;}
            }
